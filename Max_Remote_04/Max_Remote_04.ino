...
Button button2 = {LAPSE_PIN, false}; // Time Lapse ON OFF
Button button3 = {HIGHLIGHT_PIN, false}; // Highlight
Button button4 = {RESET_PIN, false}; // RESET
